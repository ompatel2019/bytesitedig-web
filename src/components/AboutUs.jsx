...
const AboutUs = () => {
  ...
  return (
    <div className='2xl:px-[160px] 2xl:py-[56px] xl:px-[96px] lg:px-[72px] md:px-[24px] sm:px-[16px] max-sm:px-[16px] py-[96px] bg-c1'>
      <div className='grid grid-cols-3 space-x-12 max-lg:space-x-4 max-md:grid-cols-1'>
        {/* Image block */}
        <div className='fade-up max-md:order-1'>
          <div className='w-full h-full bg-gray-400 rounded-lg'></div>
        </div>

        {/* Text and stats */}
        <div className='space-y-8 col-span-2 max-md:col-span-3 max-md:order-2 fade-down'>
