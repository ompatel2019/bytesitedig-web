    ...
    <div>
      <div id='pricing' className='2xl:px-[160px] 2xl:py-[56px] 2xl:pb-[16px] xl:px-[96px] lg:px-[72px] md:px-[24px] sm:px-[16px] max-sm:px-[16px] pt-[48px] lg:pb-[96px] bg-[#fafafa]'>
        ...
        <div className='flex flex-col md:flex-row md:grid grid-cols-2 gap-16 max-sm:gap-4'>
          <div className='bg-c2 p-12 rounded-lg space-y-4 max-sm:p-6 order-1 md:order-2'>
            ...
            <form action="" className='space-y-4'>
              <div className='flex space-x-4 max-sm:space-x-0 max-sm:flex-col max-sm:space-y-4'>
                <input className='bg-transparent rounded-md border-2 border-c4 p-2 px-4 font-dm-mono w-full text-c4 max-sm:text-[12px]' type="text" placeholder='Full Name' required/>
                <input className='bg-transparent rounded-md border-2 border-c4 p-2 px-4 font-dm-mono w-full text-c4 max-sm:text-[12px]' type="text" placeholder='Email' required/>
              </div>
              <input className='bg-transparent rounded-md border-2 border-c4 p-2 px-4 font-dm-mono w-full text-c4 max-sm:text-[12px]' type="text" placeholder='Phone (Optional)'/>
              <input className='bg-transparent rounded-md border-2 border-c4 py-2 px-4 font-dm-mono w-full text-c4 max-sm:text-[12px] align-top pb-32' type="text" placeholder='A short message for us...' required/>
          ...
          <div className='flex flex-col justify-around order-2 md:order-1'>
